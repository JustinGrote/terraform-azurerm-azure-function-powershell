...
output "function_app_portal_uri" {
  ...
  value = "https://portal.azure.com/#blade/WebsitesExtension/FunctionsIFrameBlade/id/%2Fsubscriptions%2F${data.azurerm_subscription.this.id}%2FresourceGroups%2F${azurerm_resource_group.this.name}%2Fproviders%2FMicrosoft.Web%2Fsites%2F${azurerm_app_service_plan.this.name}"
}
